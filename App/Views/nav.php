<nav class="navbar navbar-expand-lg navbar-dark" style="background-image: linear-gradient(to right, rgb(255,65,121), rgb(71,187,217));">
    <a class="navbar-brand" href="#"><img src="images/codingcush-logo.png" alt=""></a>
